<% @ Page language="c#" Inherits="PageAdmin.exchange"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<li>商品名称：<%=TheTitle%></li>
<li>商品库存：<%=Reserves%></li>
<li>兑换数量：<input type="text" name="num" id="num" maxlength="5" value="1" style="width:55px;border:1px solid #cccccc;" onkeyup="c_num(this.value)"></li>
<li>可用积分：<%=MyPoint%>积分</li>
<li>所需积分：<span id="points"><%=Point%></span>积分</li>
<li>联系姓名：<input type="text" name="truename" id="truename" maxlength="30"  style="width:150px;border:1px solid #cccccc;"></li>
<li>联系电话：<input type="text" name="tel" id="tel" maxlength="30"  style="width:150px;border:1px solid #cccccc;"></li>
<li>电子邮箱：<input type="text" name="email" id="email" maxlength="30"  style="width:150px;border:1px solid #cccccc;"></li>
<li>收货地址：<input type="text" name="address"  id="address" maxlength="100"  style="width:320px;border:1px solid #cccccc;"></li>
<li>邮政编码：<input type="text" name="postcode" id="postcode" maxlength="6" onkeyup="if(isNaN(value))execCommand('undo');"  style="width:150px;border:1px solid #cccccc;"></li>
  ...
  <input type="button" id="bt" value="确定兑换" class="bt" onclick="Check_Inptut()"/>
</td>
 </tr>
 <tr>
   <td align="left" style="padding-top:15px;"><span class="ts">温馨提示： </span>请详细填写姓名、收货地址、电话、邮政编码等资料，不然可能导致物品送货失败。</td>
 </tr>
</table>
