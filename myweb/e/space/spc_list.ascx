...
<div class="spc_location">当前位置：<a href="/e/space/?s=<%=Request.QueryString["s"]%>&username=<%=Request.QueryString["username"]%>"><%=Request.QueryString["username"]%>的空间</a> &gt; <%=TableName%></div>
...
<asp:Label id="Lb_PageSize" Text="20" runat="server" Visible="false"/>
