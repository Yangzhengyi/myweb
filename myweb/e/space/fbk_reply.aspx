...
private void Get_Data(int Id)
 {
   ...
   if(dr.Read())
     {
       fbk_username=Get_TrueName(dr["fbk_username"].ToString());
...
private void Add_Reply(int Id)
 {
   ...
   sql="update pa_spcfbk set [reply]='"+Sql_Format(Reply)+"',[reply_date]='"+RDate+"' where id="+Id+" and space_owner='"+UserName+"'";
   OleDbCommand Comm=new  OleDbCommand(sql,conn);
  ...
  <form name="f" method="post">
   ...
   <tr>
     ...
     <tr>
      ...
      <input type="submit" value="回复"  class="bt">&nbsp;
      <input type="button" value="关闭"  onclick="parent.ClosePop()" class="bt">&nbsp;
     </td>
    </tr>
   </form>
 </table>
