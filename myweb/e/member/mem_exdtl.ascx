...
<table border=0 cellpadding=5 cellspacing=0 align=center style="width:98%;border-width:0px;margin:5px 0 5px 0">
      <tr>
...
<br>
<div align=center>
<asp:Button Text="提交" id="bt" runat="server" CssClass="bt" Onclick="Update_Data" />
<input type="button" class="bt" value="返回"  onclick="location.href='<%=Get_Url("mem_exlst")%>'">
