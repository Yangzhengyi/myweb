...
<script type="text/javascript" src="/e/js/comm.js"></script>
</head>
<body>
...
<table border=0 cellpadding="5px" cellspacing="0" width=100% align=center style="table-layout:fixed;background-color:#D1EAFE;border:1px solid #333333;">
 <form method="post" name="issue" target="t_issue">
   <tr>
     ...
     <td align="left"><input type="text" name="title" id="title" maxlength="150" size="90" value="<%=Server.HtmlEncode(DataTitle)%>" style="background-color:#D1EAFE;border:0px solid #ffffff"></td>
   </tr>
 ...
 function postover(Act,Html_Success)
  {
    ...
    issue_item=opener.document.getElementsByName("issue_item");
