 ...
 public void Page_Load(Object src,EventArgs e)
  {
      ...
      if(IsNum(Request.QueryString["sid"]))
        {
          ...
          sql="select friend_username,friend_beizhu from pa_friends where owner='"+UserName+"' and friend_sort="+sid+" order by friend_username";
        }
       else
        {
         sql="select friend_username,friend_beizhu from pa_friends where owner='"+UserName+"' order by friend_username";
        }
     ...
     sql="select id,sort_name from pa_friends_sort where owner='"+UserName+"'order by xuhao,id";
...
<%=Friends%>
 ...
 <tr>
   ...
   <input type="button" name="Close"  value="取消" onclick="parent.ClosePop();" class="bt">
  </td>
 </tr>
</table>
