...
<%#DataBinder.Eval(Container.DataItem,"name")%></td>
 ...
 <table border=0 cellpadding=5 cellspacing=0  align=center width="98%">
  ...
  <tr>
    <td><input type="submit" value="购买" onclick="return payck()"  class="bt" /> &nbsp; <input type="button" value="返 回"   class="bt" onclick="location.href='<%=Get_Url("mem_ptlst")%>'"></td>
  </tr>
 </table>
</asp:PlaceHolder>
...
<br><br><input type="button" value="返 回"   class="bt" onclick="location.href='<%=Get_Url("mem_ptlst")%>'">
</div>
</asp:PlaceHolder>
