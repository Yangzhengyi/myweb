...
<br>
<div>您好：<span style="color:#ff0000;Font-Size:13px;font-weight:bold"><%=UserName%></span><%if(Space_Open=="1"){%>（<a href="/e/space/?s=<%=SiteId%>&username=<%=UserName%>" target="myspace">我的空间</a>）<%}%>，欢迎您登陆会员中心!</div>
<table border=0 cellpadding="2px"  align="center" class="mem_idx_table">
  <%if(ShowFnc=="1"){%>
  <tr>
  ...
  <tr>
    <td align="right">最后登陆时间：</td><td><%=Last_Date%></td>
  </tr>
</table> 
