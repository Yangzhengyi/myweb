...
<form runat="server">
 <table border="0" cellspacing="0" cellpadding="0"  align="center" class="member_table_1"> 
    <tr>
      ...
      <td align=center  class="memlist_header_item" width="15%">收件人</td> 
...
<asp:Repeater id="P1" runat="server" OnItemDataBound="P1_Bound">      
 <ItemTemplate>
      <tr>
       ...
       <td align=center  class="memlist_item_1"><a href='<%#Get_FriendUrl("mem_friendsdtl",DataBinder.Eval(Container.DataItem,"receiver").ToString())%>'><%#Get_Receiver(DataBinder.Eval(Container.DataItem,"receiver").ToString())%></a></td> 
       <td align=center  class="memlist_item_1"><%#DataBinder.Eval(Container.DataItem,"thedate","{0:yyyy-MM-dd}")%></td> 
    </tr>
 </ItemTemplate>
</asp:Repeater>
 </table> 
<div align=left style="display:<%=Show_DeletControl%>">
<br>
<input type="button" class="bt" value="反选" onclick="CheckBox_Inverse('CK')" >
<input type="button" class="bt" value="删除" onclick="Delete_Msg()" >
<br>
</div>
