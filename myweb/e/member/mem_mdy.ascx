...
<tr><td colspan="2" align="center"><input id="bt_post" type="submit"  value=" 修改资料 " onclick="return Check_Mdy()" class="bt"><td></tr>
</table>
...
<br><br><input type="button" class="bt" value=" 返回 "  onclick="location.href='<%=Get_Url("mem_mdy")%>'">
</div>
</asp:PlaceHolder>
