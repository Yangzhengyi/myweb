...
入款金额：<input name="v_amount" type=text value="<%=Request.QueryString["amount"]%>" maxlength="6" size="5" onkeyup="if(isNaN(value))execCommand('undo')">&nbsp;元
...
function C_Tb()
 {
   var M=document.formbill.v_amount.value;
   if(M=='')
    {
     alert('充值金额无效!');
     return;
