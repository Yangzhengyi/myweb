...
<form runat="server">
 <table border="0" cellspacing="0" cellpadding="0" align="center" class="member_table">
    <tr>
      ...
      <td align=center  class="memlist_header_item" width="15%">花费积分</td> 
