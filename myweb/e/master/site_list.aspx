...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>站点管理</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
function Set(name,Id)
 {
  var Width=700;
  var Height=400;
  ShowIframe(name,"site_add.aspx?act=edit&id="+Id,Width,Height,'auto');
 }
...
function html()
 {
  ...
  var Width=400;
  var Height=180;
  ShowIframe("站点静态生成","static_panel.aspx?table="+D_htmltype.value+"&siteid="+Ids+datexz,Width,Height,'no');
  //window.open("static_panel.aspx?table="+D_htmltype.value+"&siteid="+Ids+datexz,'aaaa','location=yes');
 }
