...
<div id="tabdiv">
<ul>
<li id="tab" name="tab" onclick="location.href='data_add.aspx?id=<%=Request.QueryString["id"]%>&table=<%=Request.QueryString["table"]%>&name=<%=Server.UrlEncode(Request.QueryString["name"])%>'">信息详情</li>
...
<tr>
  <td  colspan=2 height=25><b>当前位置：</b><%=Request.QueryString["name"]%> &gt; 信息回复</td>
 </tr>
</table>
