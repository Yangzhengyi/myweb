...
<tr>
  <td  colspan=2 height=25  align="left"><b>问卷列表</b></td>
 </tr>
</table>
    ...
    <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
      <tr>
        <td  colspan=2 height=25>
                ...
                <tr>
                  <td align=center width=45% class=white height=25px>标题</td>
          ...
          <asp:Repeater id="DL_1" runat="server"  OnItemDataBound="Data_Bound">       
             <ItemTemplate>
                <tr>
                  <td align=left width=45% class=tdstyle>
...
<asp:ListItem Value="0">无限制</asp:ListItem>
                  ...
                  <td align=center width=15% class=tdstyle><asp:TextBox id="Tb_EndDate" maxlength="10" size=10  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"EndDate","{0:yyyy-MM-dd}")%>'/></td>
                  ...
                  <td align=center width=25% class=tdstyle>
                   ...
                   <a href="vote_quesion.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&title=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"title").ToString())%>">问卷设置</a>
                    ...
                    <a href="#" onclick="window.open('/e/vote/voteview.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>','view','top=60,left=100,height=500,width=800,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no')">查看</a>
