...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>积分兑换记录</b></td></tr>
</table>
...
<tr>
  <td  width=50% height=25><b>积分兑换记录</b></td>
 ...
 <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
      <tr>
        <td  colspan=2 height=25>
          ...
          <asp:DataList id="dtl1" runat="server" border=0 RepeatLayout="Table" width=100% cellspacing=0 cellpadding=0  OnItemDataBound="Data_Bound">  
            <headerTemplate>
             ...
             <ItemTemplate>
              <table border=0 cellpadding=0 cellspacing=0 width=100% class=tablestyle>
               <tr>
                  <td height=25  width=30%  align=left  class=tdstyle><input type="checkbox" id="CK" Name="CK" Value="<%#DataBinder.Eval(Container.DataItem,"id")%>"><a href='<%#Get_DetailUrl(DataBinder.Eval(Container.DataItem,"thetable").ToString(),DataBinder.Eval(Container.DataItem,"detail_id").ToString())%>' target='view'><%#DataBinder.Eval(Container.DataItem,"title")%></a></td>
                  ...
                  <td height=25  width=15%  align=center  class=tdstyle><%#DataBinder.Eval(Container.DataItem,"paypoint")%></td>
                  <td height=25  width=15%  align=center  class=tdstyle><%#DataBinder.Eval(Container.DataItem,"thedate","{0:yyyy-MM-dd}")%></td>
                  <td height=25  width=10%  align=center  class=tdstyle><%#Get_SendState(DataBinder.Eval(Container.DataItem,"sendstate").ToString())%></td>
                  <td height=25  width=10%  align=center  class=tdstyle><a href='member_info.aspx?username=<%#DataBinder.Eval(Container.DataItem,"username")%>'><%#DataBinder.Eval(Container.DataItem,"operator")%></a></td>
                  <td height=25  width=10%  align=center class=tdstyle >
<a href='exchange_info.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&username=<%=UserName%>'>查看</a>
