      ...
      <tr>
        <td  align="left">
           <table border=0 cellpadding=0 cellspacing=0 width=100% class=tablestyle style="table-layout:fixed;">
                <tr>
                  <td align=center width=50% class=white  height=20><%=TitleName%></td>
                  <td align=center width=10% class=white>发布人</td>
                  <td align=center width=10% class=white>提交时间</td>
