                 ...
                 <asp:DataList id="DataList_1" runat="server" border=0 RepeatLayout="Table" width=100% cellspacing=0 cellpadding=0
                   OnItemDataBound="Data_Bound"  OnDeleteCommand="Data_Delete"> 
                    <HeaderTemplate> 
                      ...
                      <tr>
                      <td align=center width=20% class=white height=20>模型id</td>
                      <td align=center width=20% class=white>模型名称</td>
                    ...
                    <ItemTemplate>
                      <table border=0 cellpadding=0 cellspacing=0 width=100%  class=tablestyle>
                       <tr>
                        <td align=center width=20% class=tdstyle><asp:TextBox Text='<%#DataBinder.Eval(Container.DataItem,"id")%>' runat="server" size="2" readonly/></a></td>
                        <td align=center width=20% class=tdstyle><asp:TextBox id="Tb_Name" Text='<%#DataBinder.Eval(Container.DataItem,"name")%>' runat="server" size="25" maxlength="50" /></a></td>
                        <td align=center width=10% class=tdstyle><asp:DropDownList id="D_Language" runat="server" /></td>
                        <td align=center width=20% class=tdstyle><asp:TextBox id="Xuhao"  Text='<%#DataBinder.Eval(Container.DataItem,"xuhao")%>' runat="server"  size=5  maxlength=10 /></td>
                        <td width=30% class=tdstyle align=center>
...
function Model_Set(Table,Type,Name,Id)
 {
  ...
  if(NW!=null)
   {
    try{NW.window.close();}catch(e){}
   }
  NW=window.open("model_set.aspx?table="+Table+"&id="+Id+"&type="+Type+"&Name="+encodeURI(Name),Id,"width="+Width+",height="+Height+",top="+Top+",left="+Left+",toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no");
 }
</script>
</body>
</html>  
