...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>增加任务</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<tr>
  ...
  <tr><td height=25 ><b>当前位置</b>：<%=Request.QueryString["id"]==null?"增加计划任务":"修改计划任务"%></td></tr>
 </table>

<table border=0 cellpadding=2 cellspacing=2 width=95% align=center>
 </tr>
  <tr>
  <td  height=25 width=100px>任务名称</td>
  <td><input name="name" id="name" type="text" maxlength="50" size="30" value="<%=Name%>"></td>
 </tr>

  <tr>
  <td height=25 width=100px>执行文件名</td>
  <td><input name="fileurl" id="fileurl" type="text" maxlength="50" size="30" value="<%=FileUrl%>"> <span style="color:#666666">文件请放在/e/task目录中,此处只需填写文件名如：task.aspx</a></td>
  </tr>
  ...
  <tr>
  <td  height=25 width=100px>任务启用</td>
  ...
  <tr>
  <td  height=25 width=100px>是否循环</td>
...
<input type="button" class=button value="返回"  onclick="location.href='task_list.aspx'">
</span>  
