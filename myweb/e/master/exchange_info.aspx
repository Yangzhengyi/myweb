...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>兑换详细资料</b></td></tr>
</table>
...
<input type="button" class=button  value="返回"  onclick="location.href='exchange_list.aspx?username=<%=Request.QueryString["username"]%>'">
