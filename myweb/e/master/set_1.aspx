...
<li id="tab" name="tab"  onclick="showtab(3)">其他参数设置</li>
</ul>
</div>
...
<tr>
  <td align="left" colspan=2 height=30px><b>基本属性设置</b></td>
 </tr>
<tr>
  <td align="left"  style="width:100px">选择风格<a href="template_edit.aspx?template=<%=Css_path%>/lanmu.css"><img src=images/edit.gif width=20 height=20 align=absmiddle vspace=5 hspace=5 border=0 alt="编辑模板"></a></td>
 <td align="left">
...
<aspcn:uc_fckeditor  Tb_Id="wz_top" Fck_Height="250" Fck_Style="Simple" runat="server"/>
</td>
 </tr>
...
<aspcn:uc_fckeditor Tb_Id="wz_banner" Fck_Height="250" Fck_Style="Simple" runat="server"/>
</td>
</tr>
...
<aspcn:uc_fckeditor  Tb_Id="wz_bottom" Fck_Height="250" Fck_Style="Simple" runat="server"/>
</td>
 </tr>
</table>
</div>
...
<aspcn:uc_fckeditor Tb_Id="em_sign" Fck_Height="120" Fck_Style="Simple" runat="server" />
</td>
 </tr>
</table>
</div>
...
<tr>
  <td align="left" colspan="2"><b>其他参数设置</b></td>
 </tr>
<tr>
