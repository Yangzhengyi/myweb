...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b><%=TypeName%>自定义样式</b></td></tr>
 <tr><td height=10></td></tr>
</table>
    ...
    <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
      <tr>
        <td colspan=2 height=25>
          <table border=0 cellpadding=3 cellspacing=0 width=100% class=tablestyle >
                <tr>
             ...
             <ItemTemplate>
                <tr>
                  ...
                  <td align=center class=tdstyle>
                   ...
                   <a href="lanmu_style_set.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&type=<%=Thetype%>&name=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"name").ToString())%>">设置</a>
...
<tr>
  <td valign=top>
    <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
    <tr><td  colspan=3 height=25><b>增加<%=TypeName%>样式</b></td>
    </tr>
      <tr>
        <td  height=25>样式名称：<asp:TextBox  id="Add_Name"  maxlength=40 size=20  runat="server" />
