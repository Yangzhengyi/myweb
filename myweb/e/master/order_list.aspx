...
<option value="nosend">已付款(未发货)</option>
<option value="sended">已付款(已发货)</option>
</select>
...
关键字<input text="text" id="s_keyword" size="6">
<select id="s_field">
          ...
          <asp:DataList id="dtl1" runat="server" border=0 RepeatLayout="Table" width=100% cellspacing=0 cellpadding=0  OnItemDataBound="Data_Bound">  
            <headerTemplate>
             ...
             <ItemTemplate>
              <table border=0 cellpadding=0 cellspacing=0 width=100% class=tablestyle>
               <tr>
                  <td height=25  width=20%  align=left  class=tdstyle><input type="checkbox" id="CK" Name="CK" Value="<%#DataBinder.Eval(Container.DataItem,"order_id")%>"><a href='/e/order/orderview.aspx?orderid=<%#DataBinder.Eval(Container.DataItem,"order_id")%>' target='orderview'><%#DataBinder.Eval(Container.DataItem,"order_id")%></a></td>
...
<a href='order_info.aspx?orderid=<%#DataBinder.Eval(Container.DataItem,"order_id")%>&username=<%=UserName%>'>查看</a>
