...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>会员留言</b></td></tr>
</table>
...
<tr><td height=25><b>会员留言</b></td></tr>
</table>
...
会员名:<input text="text" id="s_username" size="10">
          ...
          OnItemDataBound="PageAdmin_Data_Bound">  
            <headerTemplate>
             ...
             <ItemTemplate>
              <table border=0 cellpadding=0 cellspacing=0 width=100% class=tablestyle style="table-layout:fixed;">
               <tr>
                  <td height=25  width=50%  align=left class=tdstyle><input type="checkbox" id="CK" Name="CK" Value="<%#DataBinder.Eval(Container.DataItem,"id")%>">[<%#DataBinder.Eval(Container.DataItem,"type")%>]<a href='feedback_info.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&username=<%#Request.QueryString["username"]%>&replay=<%#Request.QueryString["replay"]%>'><%#DataBinder.Eval(Container.DataItem,"title")%></a></td>
                  <td height=25  width=10%  align=center class=tdstyle><%#Get_state(DataBinder.Eval(Container.DataItem,"reply_state").ToString())%></span></td></td>
...
<a href='feedback_info.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&username=<%#Request.QueryString["username"]%>&type=<%#Request.QueryString["type"]%>'>查看</a>
