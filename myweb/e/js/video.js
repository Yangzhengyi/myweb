...
{
 jwplayer(width,height,"file="+url+"&autostart=false");
}
...
function jwplayer(width,height,vars)
{
 document.write('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"><param name="movie" value="/e/images/swf/player.swf" width="'+width+'" height="'+height+'"/><param name="quality" value="high" /><param name="menu" value="false"><param name="wmode" value="transparent" /><embed src="/e/images/swf/player.swf" allowfullscreen="true" flashvars="'+vars+'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+width+'" height="'+height+'" menu="false"></embed></object>');
}